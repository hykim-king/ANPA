...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		const firstNavLink = document
				.querySelector('.nav .nav-item:nth-child(4) .nav-link');
	...
	<div class="container">
		...
		<div class="mb-2 d-grid gap-2 d-md-flex justify-content-md-end">
			<input type="button" value="목록" class="btn btn-primary"
				onclick="window.location.href ='/ehr/board/'+${divYn}+'.do'">
		...
		<form action="#" class="form-horizontal" name="regForm" id="regForm">
			...
			<div class="row mb-2"">
				...
				<div class="col-sm-10">
					<textarea style="height: 200px" class="form-control" id="contents"
