...
/*     var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));
    tooltipTriggerList.map(function (tooltipTriggerEl) {
        var customText = tooltipTriggerEl.getAttribute('data-bs-custom');
        return new bootstrap.Tooltip(tooltipTriggerEl, {
            title: customText
        });
    });  */
    var tooltip = document.getElementById('tooltipBox');
    var pathElements = document.querySelectorAll('.land');

    pathElements.forEach(function (pathElement) {
        pathElement.addEventListener('mouseover', function (event) {
            var customText = pathElement.getAttribute('data-bs-custom');
...
<section class="content content2 align-items-center">
    ...
    <!-- 카테고리 버튼 -->
    <div class="select_date row g-1 mt-1 d-flex align-items-center">
        <button type="button" class="btn btn-success me-2" id = "factor">화재요인</button> 
        <button type="button" class="btn btn-secondary" id = "location">화재장소</button>
    </div>
    <!-- //카테고리 버튼 -->
    
    <form name = "fRfrm" id = "fRfrm" class="row g-1 mt-2">
    ...
    <div class="input_date d-flex align-items-center mt-2">
         <!-- 상단 좌측 검색 조건 -->
         <div class="search-conditions">
             <p class="form-control work_div_result m-0">검색 조건 : <span id="searchConditions"></span></p>
         </div>
         
         <!-- 하단 좌측 검색 날짜 -->
         <div class="search-date col-md-6">
             <p class="m-0 col-md-auto"><i class="bi bi-calendar"></i> 검색기간 : </p>
             <input type="date" class="form-input form-control" name="fRdateStart" id="fRdateStart" min="${minMaxDate.regDt}" max="${minMaxDate.modDt}">
             <p class="m-0"> - </p>
             <input type="date" class="form-input form-control" name="fRdateEnd" id="fRdateEnd" min="${minMaxDate.regDt}" max="${minMaxDate.modDt}">
         </div>
    ...
    <form name = "cityfrm" id = "cityfrm" class="row g-1 mt-2">
    ...
    <!-- (c) ammap.com | SVG map of South Korea - High -->
        <div class="svgBoxInner1" >        
          <svg xmlns="http://www.w3.org/2000/svg" class="map" viewBox="0 30 500 770" style="position : relative;">
            <defs>
